...
class DmptemplatesControllerTest < ActionController::TestCase
  ...
  test "should create dmptemplate" do
    assert_difference('Dmptemplate.count') do
      post :create, dmptemplate: { description: @dmptemplate.description, published: @dmptemplate.published, title: @dmptemplate.title }
    end
  ...
  test "should update dmptemplate" do
    put :update, id: @dmptemplate, dmptemplate: { description: @dmptemplate.description, published: @dmptemplate.published, title: @dmptemplate.title }
    assert_redirected_to dmptemplate_path(assigns(:dmptemplate))
  end
