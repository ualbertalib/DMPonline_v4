  ...
  def create
    ...
    respond_to do |format|
      if @user_role_type.save
        format.html { redirect_to @user_role_type, notice: t('helpers.notices.user_role_created') }
  ...
  def update
    ...
    respond_to do |format|
      if @user_role_type.update_attributes(params[:user_role_type])
        format.html { redirect_to @user_role_type, notice: t('helpers.notices.user_role_updated') }
