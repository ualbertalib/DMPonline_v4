class UserStatusesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_status.save
        format.html { redirect_to @user_status, notice: t(helpers.notices.user_status_created') }
  ...
  def update
    ...
    respond_to do |format|
      if @user_status.update_attributes(params[:user_status])
        format.html { redirect_to @user_status, notice: t(helpers.notices.user_status_updated') }
