  ...
  def create
    ...
    respond_to do |format|
      if @user_org_role.save
        format.html { redirect_to @user_org_role, notice: t('helpers.notices.user_org_role_created') }
  ...
  def update
    ...
    respond_to do |format|
      if @user_org_role.update_attributes(params[:user_org_role])
        format.html { redirect_to @user_org_role, notice: t('helpers.notices.user_org_role_updated') }
