...
DMPonline is a Ruby on Rails application and you will need to have Ruby 2.0.0p247 or greater and Rails 3.2.13 installed on your server and a MySQL server v5.0 or greater.
...
Copyright (c) 2013 Digital Curation Centre, University of Edinburgh. See AGPL-LICENSE for details.
