...
This is just the application code, the accompanying question data available at https://dmponline-beta.dcc.ac.uk is not included.
...
DMP Online is a Ruby on Rails application and you will need to have Ruby 2.0.0p247 or greater installed on your server and a MySQL server v5.0 or greater.
