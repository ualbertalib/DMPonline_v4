...
const char * LIB_PATH_VALUE   = "/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ext/nokogiri/tmp/i686-pc-cygwin/ports/libxml2/2.8.0/libxml2-2.8.0/.libs:/usr/lib:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ext/nokogiri/tmp/i686-pc-cygwin/ports/libxml2/2.8.0/libxml2-2.8.0/.libs:/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ports/i686-pc-cygwin/libxml2/2.8.0/lib:/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ports/i686-pc-cygwin/libxml2/2.8.0/bin:";
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# testAutomata - temporary wrapper script for .libs/testAutomata\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The testAutomata program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ./libxml2.la /usr/lib/liblzma.la /usr/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"testAutomata:testAutomata:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"testAutomata:testAutomata:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"testAutomata:testAutomata:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ext/nokogiri/tmp/i686-pc-cygwin/ports/libxml2/2.8.0/libxml2-2.8.0/.libs:/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ports/i686-pc-cygwin/libxml2/2.8.0/lib:/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ports/i686-pc-cygwin/libxml2/2.8.0/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/dmponline/DMPonline_v4/vendor/ruby/1.9.1/gems/nokogiri-1.6.1/ext/nokogiri/tmp/i686-pc-cygwin/ports/libxml2/2.8.0/libxml2-2.8.0/.libs:/usr/lib:$PATH\"\n", f);
  fputs ("\n", f);
